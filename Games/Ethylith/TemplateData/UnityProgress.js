function UnityProgress (dom) {
	...
	logoImage.src = "https://dl.dropboxusercontent.com/u/85846965/ethylith/webgl/TemplateData/progresslogo.png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "https://dl.dropboxusercontent.com/u/85846965/ethylith/webgl/TemplateData/loadingbar.png"; 
	progressFrame.style.position = "absolute";
	parent.appendChild(progressFrame);
	this.progressFrame = progressFrame;

	var progressBar = document.createElement("img");
	progressBar.src = "https://dl.dropboxusercontent.com/u/85846965/ethylith/webgl/TemplateData/fullscreen.png";
